...
A = sm.simulate_slice(map_r=map_original, psize=.5, n_particles=10, N_crop=None, snr=0.1, do_snr=False, do_ctf=True, df_min=15000, df_max=15000,
...
np.save('/scratch/ex-kdd-1/NicolasLegendre/Cryo/Data/simulationGeoffNoNoise.npy', NoNoise)
